...
10. Waiting
   10.1. sleep(<seconds>)
11. String
   11.1. concat(<string>, <string>)
   11.2. letter(<int>, <var>)
   11.3. includes(<string>, <var>)
   11.4. startswith(<string>, <var>)
   11.5. index(<string>, <var>)
   11.6. len(<var>)
   11.7. shush(<string>)
   11.8. scream(<string>)
12. Algebra
...
3. print(<any>) # print can print variable values.
print can also be displayed as print("<str>") that can NOT display variables but can print integers, floats, and strings. the output will be displayed in the words list.
...
2. sine(<int>) # this trigonometric operator returns the sine of the input in degrees. The output is outputted to a variable named "output".
...
1. sleep(<seconds>) # a line of code that will stop the project for <input> seconds. This is inputted directly in the run Dango script.
...
1. concat(<string>, <string>) # this string operator joins the first and second string. This can't read variable values and can't join anything except strings. The output is outputted to a variable named "output".
